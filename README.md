...
<li>🎮 <b>Mechanical & Digital Art</b> - Meticulous Gunpla builder by night and devoted Hideo Kojima universe explorer (I actually named some of the product I deployed commercially using Metal Gear Solid's names). Because sometimes the best way to unwind from complex algorithms is with equally complex narrative mind-bends.</li>
